...
const getSingleStudentEnrolledCourse = catchAsync(async (req: Request, res: Response) => {
    const { id } = req.params;
    const result = await StudentEnrolledCourseService.getSingleStudentEnrolledCourse(id);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
